...
const DynamicCounterBanner = () => {
  ...
  return (
    <div className="bg-sky-500/20 border border-sky-400/30 rounded-lg py-3 px-6 max-w-max mx-auto shadow-lg shadow-sky-500/10 transform hover:scale-[1.02] transition-transform duration-300">
      <p className="text-white text-base sm:text-lg font-sans text-center">
        ...
        <span className="sm:inline"> professores já usam o Gêniozinho em Ação!</span>
        <span className="sm:hidden">
          {' '}professores já 
          <br />
          usam o Gêniozinho em Ação!
        </span>
      </p>
    </div>
  );
