...
const DynamicCounterBanner = () => {
  ...
  return (
    <div className="bg-sky-500/20 border border-sky-400/30 rounded-lg py-3 px-6 max-w-max mx-auto shadow-lg shadow-sky-500/10 transform hover:scale-[1.02] transition-transform duration-300 animate-pulse">
