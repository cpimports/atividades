...
const DynamicCounterBanner = () => {
  ...
  return (
    <div className="bg-sky-500/20 border border-sky-400/30 rounded-lg py-1 px-3 max-w-max mx-auto shadow-lg shadow-sky-500/10 transform hover:scale-[1.02] transition-transform duration-300">
      <p className="text-white text-[11px] font-sans text-center">
        <span className="sm:inline">Mais de{' '}</span>
        <span className="text-yellow-300 font-bold text-xs tracking-wide mx-0.5">
