...
const steps = [
  {
    icon: <Image src="https://images.wsrv.nl/?url=i.imgur.com/z0BAXDu.png&output=webp" alt="Email icon" data-ai-hint="email mail" width={40} height={40} className="text-primary" />,
    title: 'RECEBA EM SEU E-MAIL',
    description: 'Receba Imediatamente em seu e-mail.',
  },
  {
    icon: <Image src="https://images.wsrv.nl/?url=i.imgur.com/kozs9lt.png&output=webp" alt="Printer icon" data-ai-hint="printer document" width={40} height={40} className="text-accent-foreground" />,
    title: 'ACESSE E IMPRIMA QUANDO QUISER',
    description: 'Acesse e imprima quando e quantas vezes preferir.',
  },
  {
    icon: <Image src="https://images.wsrv.nl/?url=i.imgur.com/8HMLXYb.png&output=webp" alt="Play icon" data-ai-hint="play button" width={40} height={40} className="text-primary" />,
