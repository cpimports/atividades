...
const testimonialsData: Testimonial[] = [
  {
    ...
    avatarUrl: 'https://images.wsrv.nl/?url=i.imgur.com/iDxyKPn.png&output=webp',
    avatarFallback: 'CM',
  ...
  },
  {
    ...
    avatarUrl: 'https://images.wsrv.nl/?url=i.imgur.com/jZ6Cs3g.jpeg&output=webp',
    avatarFallback: 'VG',
  ...
  },
  {
    ...
    avatarUrl: 'https://images.wsrv.nl/?url=i.imgur.com/zUeo9qC.jpeg&output=webp',
    avatarFallback: 'AP',
  ...
  },
  {
    ...
    avatarUrl: 'https://images.wsrv.nl/?url=i.imgur.com/OcXCdY4.jpeg&output=webp',
    avatarFallback: 'RT',
...
const YouTubeFacade = ({ videoId, title }: { videoId: string, title: string }) => {
  ...
  const thumbnailUrl = `https://images.wsrv.nl/?url=img.youtube.com/vi/${videoId}/hqdefault.jpg&output=webp`;
