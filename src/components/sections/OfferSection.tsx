      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto bg-blue-800 rounded-2xl shadow-2xl overflow-hidden border-2 border-blue-900 relative">
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
              <span className="absolute top-[2%] left-[5%] text-4xl opacity-20 transform -rotate-12">🧩</span>
              ...
              <span className="absolute top-[25%] right-[22%] text-5xl opacity-20 transform -rotate-15">🧩</span>
              <span className="absolute top-[35%] left-[10%] text-5xl opacity-20 transform rotate-5">🧩</span>
              <span className="absolute top-[45%] right-[12%] text-3xl opacity-20 transform rotate-12">🧩</span>
              <span className="absolute top-[55%] left-[25%] text-6xl opacity-20 transform -rotate-5">🧩</span>
              <span className="absolute top-[65%] right-[2%] text-4xl opacity-20 transform rotate-20">🧩</span>
              <span className="absolute top-[75%] left-[15%] text-3xl opacity-20 transform rotate-15">🧩</span>
              <span className="absolute top-[85%] right-[18%] text-5xl opacity-20 transform -rotate-10">🧩</span>
              <span className="absolute bottom-[2%] right-[5%] text-4xl opacity-20 transform rotate-12">🧩</span>
              <span className="absolute bottom-[10%] left-[8%] text-6xl opacity-20 transform -rotate-20">🧩</span>
              <span className="absolute bottom-[15%] right-[20%] text-3xl opacity-20 transform -rotate-10">🧩</span>
              <span className="absolute bottom-[25%] left-[22%] text-5xl opacity-20 transform rotate-15">🧩</span>
              <span className="absolute bottom-[35%] right-[10%] text-5xl opacity-20 transform -rotate-5">🧩</span>
              <span className="absolute bottom-[45%] left-[12%] text-3xl opacity-20 transform -rotate-12">🧩</span>
              <span className="absolute top-[50%] left-[45%] text-8xl opacity-10 transform -rotate-10">🧩</span>
              <span className="absolute top-[5%] left-[40%] text-2xl opacity-20 transform rotate-10">🧩</span>
              <span className="absolute top-[80%] left-[40%] text-3xl opacity-20 transform -rotate-12">🧩</span>
              <span className="absolute top-[90%] left-[60%] text-2xl opacity-20 transform rotate-15">🧩</span>
              <span className="absolute top-[5%] right-[40%] text-2xl opacity-20 transform -rotate-5">🧩</span>
              <span className="absolute top-[30%] left-[65%] text-4xl opacity-20 transform rotate-8">🧩</span>
              <span className="absolute bottom-[5%] left-[50%] text-3xl opacity-20 transform rotate-12">🧩</span>
              <span className="absolute top-[5%] left-[5%] text-2xl opacity-20 transform rotate-12 scale-x-[-1]">🧩</span>
              <span className="absolute top-[10%] right-[8%] text-4xl opacity-20 transform -rotate-20">🧩</span>
              <span className="absolute top-[15%] left-[20%] text-xl opacity-20 transform -rotate-10 scale-y-[-1]">🧩</span>
              <span className="absolute top-[25%] right-[22%] text-3xl opacity-20 transform rotate-15">🧩</span>
              <span className="absolute top-[35%] left-[10%] text-4xl opacity-20 transform -rotate-5 scale-x-[-1]">🧩</span>
              <span className="absolute top-[45%] right-[12%] text-2xl opacity-20 transform -rotate-12">🧩</span>
              <span className="absolute top-[55%] left-[25%] text-5xl opacity-20 transform rotate-5">🧩</span>
              <span className="absolute top-[65%] right-[2%] text-3xl opacity-20 transform -rotate-20 scale-y-[-1]">🧩</span>
              <span className="absolute top-[75%] left-[15%] text-2xl opacity-20 transform -rotate-15">🧩</span>
              <span className="absolute top-[85%] right-[18%] text-4xl opacity-20 transform rotate-10">🧩</span>
              <span className="absolute bottom-[2%] right-[5%] text-3xl opacity-20 transform -rotate-12 scale-x-[-1]">🧩</span>
              <span className="absolute bottom-[10%] left-[8%] text-5xl opacity-20 transform rotate-20">🧩</span>
              <span className="absolute bottom-[15%] right-[20%] text-2xl opacity-20 transform rotate-10">🧩</span>
              <span className="absolute bottom-[25%] left-[22%] text-4xl opacity-20 transform -rotate-15 scale-y-[-1]">🧩</span>
              <span className="absolute bottom-[35%] right-[10%] text-4xl opacity-20 transform rotate-5">🧩</span>
              <span className="absolute bottom-[45%] left-[12%] text-2xl opacity-20 transform rotate-12">🧩</span>
              <span className="absolute top-[50%] left-[45%] text-7xl opacity-10 transform rotate-10 scale-x-[-1]">🧩</span>
              <span className="absolute top-[5%] left-[40%] text-xl opacity-20 transform -rotate-10">🧩</span>
              <span className="absolute top-[80%] left-[40%] text-2xl opacity-20 transform rotate-12">🧩</span>
              <span className="absolute top-[90%] left-[60%] text-xl opacity-20 transform -rotate-15 scale-y-[-1]">🧩</span>
              <span className="absolute top-[5%] right-[40%] text-xl opacity-20 transform rotate-5">🧩</span>
              <span className="absolute top-[30%] left-[65%] text-3xl opacity-20 transform -rotate-8">🧩</span>
              <span className="absolute bottom-[5%] left-[50%] text-2xl opacity-20 transform -rotate-12">🧩</span>
          </div>
