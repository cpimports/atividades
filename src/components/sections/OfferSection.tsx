      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto bg-blue-800 rounded-2xl shadow-2xl overflow-hidden border-2 border-blue-900 relative">
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
              ...
              <span className="absolute top-[10%] right-[8%] text-6xl opacity-15 transform rotate-20">🧩</span>
              ...
              <span className="absolute top-[35%] left-[10%] text-5xl opacity-15 transform rotate-5">🧩</span>
              ...
              <span className="absolute top-[65%] right-[2%] text-4xl opacity-15 transform rotate-20">🧩</span>
              ...
              <span className="absolute bottom-[10%] left-[8%] text-6xl opacity-15 transform -rotate-20">🧩</span>
              ...
              <span className="absolute bottom-[35%] right-[10%] text-5xl opacity-15 transform -rotate-5">🧩</span>
              ...
              <span className="absolute top-[80%] left-[40%] text-3xl opacity-15 transform -rotate-12">🧩</span>
              ...
              <span className="absolute top-[30%] left-[65%] text-4xl opacity-15 transform rotate-8">🧩</span>
