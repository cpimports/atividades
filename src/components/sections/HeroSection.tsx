  ...
  return (
    <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-indigo-800 to-slate-900 relative overflow-hidden">
      <div className="absolute inset-0 opacity-20 filter blur-3xl pointer-events-none">
        {/* Cloud Elements */}
        <div className="absolute top-[-15%] left-[-20%] w-[500px] h-[300px] bg-[radial-gradient(ellipse_at_center,theme(colors.indigo.300)_0%,transparent_70%)] rounded-full animate-cloud-drift-slow"></div>
        <div className="absolute top-[10%] right-[-25%] w-[600px] h-[350px] bg-[radial-gradient(ellipse_at_center,theme(colors.indigo.300)_0%,transparent_75%)] rounded-full animate-cloud-drift-medium opacity-80"></div>
        <div className="absolute bottom-[-10%] left-[5%] w-[450px] h-[250px] bg-[radial-gradient(ellipse_at_center,theme(colors.indigo.300)_0%,transparent_65%)] rounded-full animate-cloud-drift-slow opacity-90"></div>
        <div className="absolute bottom-[5%] right-[0%] w-[300px] h-[200px] bg-[radial-gradient(ellipse_at_center,theme(colors.indigo.300)_0%,transparent_70%)] rounded-full animate-cloud-drift-medium"></div>
      </div>
